...
# Form implementation generated from reading ui file 'f:\code\python\Semantic segmentation\autogis\axis_trans\axisTrans.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_changePenColor = QtWidgets.QAction(MainWindow)
        self.action_changePenColor.setObjectName("action_changePenColor")
        self.action_changeAreaColor = QtWidgets.QAction(MainWindow)
        self.action_changeAreaColor.setObjectName("action_changeAreaColor")
        self.action_bgDiaph = QtWidgets.QAction(MainWindow)
        self.action_bgDiaph.setObjectName("action_bgDiaph")
        self.action_kernelSize = QtWidgets.QAction(MainWindow)
        self.action_kernelSize.setObjectName("action_kernelSize")
        self.action_iterNum = QtWidgets.QAction(MainWindow)
        self.action_iterNum.setObjectName("action_iterNum")
        ...
        self.menu_3.addAction(self.action_changePenColor)
        self.menu_3.addAction(self.action_changeAreaColor)
        self.menu_3.addAction(self.action_bgDiaph)
        self.menu_3.addAction(self.action_kernelSize)
        self.menu_3.addAction(self.action_iterNum)
        ...
        self.action_bgDiaph.triggered.connect(MainWindow.bgDiaph)
        self.action_iterNum.triggered.connect(MainWindow.iterNum)
        self.action_changePenColor.triggered.connect(MainWindow.penColor)
        self.action_changeAreaColor.triggered.connect(MainWindow.areaColor)
        self.action_kernelSize.triggered.connect(MainWindow.kernelSize)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_changePenColor.setText(_translate("MainWindow", "画笔颜色"))
        self.action_changeAreaColor.setText(_translate("MainWindow", "区域颜色"))
        self.action_bgDiaph.setText(_translate("MainWindow", "背景透明度"))
        self.action_kernelSize.setText(_translate("MainWindow", "核大小"))
        self.action_iterNum.setText(_translate("MainWindow", "迭代次数"))
